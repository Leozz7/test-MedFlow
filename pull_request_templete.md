Seu Nome | Data de Finalização (DD-MM-AAAA)

Descrição
Por favor, forneça uma descrição geral do que você implementou neste PR.

Decisões Técnicas e Trade-offs
Explique brevemente as principais decisões técnicas tomadas durante o desenvolvimento, bem como eventuais trade-offs (por que escolheu uma solução em vez de outra, prós e contras considerados).
